...
Blockly.Blocks['beginpath'] = {
    init: function() {
        this.appendValueInput("moveTo")
            .setCheck(null)
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("beginPath");
        this.appendDummyInput()
            .appendField("端点样式")
            .appendField(new Blockly.FieldDropdown([["butt","butt"], ["round","round"], ["square","square"]]), "lineCap");
        this.appendDummyInput()
            .appendField("折点样式")
            .appendField(new Blockly.FieldDropdown([["miter","miter"], ["round","round"], ["bevel","bevel"]]), "lineJoin");
...
Blockly.Blocks['quadraticcurveto'] = {
    init: function() {
        this.appendValueInput("quadraticCurveTo")
            .setCheck(null)
            .appendField("二次贝塞尔曲线");
...
Blockly.Blocks['arcto'] = {
    init: function() {
        ...
        this.appendValueInput("startY")
            ...
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("起点 Y");
        this.appendValueInput("endX")
            .setCheck("Number")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("终点X");
        this.appendValueInput("endY")
            .setCheck("Number")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("终点Y");
        this.appendValueInput("R")
...
Blockly.Blocks['fillfont'] = {
    init: function() {
        ...
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("水平对齐")
            .appendField(new Blockly.FieldDropdown([["start","start"], ["end","end"], ["center","center"], ["left","left"], ["right","right"]]), "textAlign");
        this.setInputsInline(false);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(120);
...
Blockly.Blocks['scale'] = {
    init: function() {
        this.appendDummyInput()
            .appendField("缩放");
        this.appendValueInput("scalewidth")
            .setCheck("Number")
            .appendField("scaleWidth");
        this.appendValueInput("scaleheight")
            .setCheck("Number")
            .appendField("scaleHeight");
...
Blockly.Blocks['createlineargradient'] = {
    init: function() {
        this.appendValueInput("createLinearGradient")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("线性渐变");
        this.appendValueInput("startX")
            .setCheck("Number")
...
Blockly.Blocks['createlineargradient'] = {
    init: function() {
        this.appendValueInput("variable")
            ...
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("变量输入");
        this.appendValueInput("createLinearGradient1")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("线性渐变1");
        this.appendValueInput("createLinearGradient2")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("线性渐变2");
        this.appendValueInput("createLinearGradient3")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("线性渐变3");
        this.appendValueInput("createLinearGradient4")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("线性渐变4");
        this.appendValueInput("createLinearGradient5")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("线性渐变5");
        this.appendValueInput("startX")
...
Blockly.Blocks['createradialgradient'] = {
    init: function() {
        this.appendValueInput("variable")
            ...
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("变量输入");
        this.appendValueInput("createRadialGradient1")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("径向渐变1");
        this.appendValueInput("createRadialGradient2")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("径向渐变2");
        this.appendValueInput("createRadialGradient3")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("径向渐变3");
        this.appendValueInput("createRadialGradient4")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("径向渐变4");
        this.appendValueInput("createRadialGradient5")
            .setCheck("addColorStop")
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("径向渐变5");
        this.appendValueInput("startX")
...
Blockly.Blocks['requestAnimationFrame'] = {
    init: function() {
        this.appendValueInput("variable")
            .setCheck("String")
            .appendField("输入变量");
        this.appendStatementInput("requestAnimationFrame")
            .setCheck(null)
...
Blockly.Blocks['clearrect'] = {
    init: function() {
        this.appendDummyInput()
            .appendField("清空Canvas")
            .appendField("X1")
            .appendField(new Blockly.FieldTextInput("0"), "X1")
            .appendField("Y1")
            .appendField(new Blockly.FieldTextInput("0"), "Y1")
            .appendField("X2")
            .appendField(new Blockly.FieldTextInput("100"), "X2")
            .appendField("Y2")
            .appendField(new Blockly.FieldTextInput("100"), "Y2");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(120);
        this.setTooltip("");
...
Blockly.Blocks['runanimate'] = {
    init: function() {
        this.appendDummyInput()
            .appendField("调用requestanimateframe");
        this.appendValueInput("variable")
            .setCheck(null)
            .setAlign(Blockly.ALIGN_CENTRE)
            .appendField("输入变量");
